...
public class Five extends HotFormations{
    public boolean consecutiveFivePiece(Piece p, int sign, Piece.PieceType col, Directions dir) {
    ...
    public boolean fiveBoundaries(Piece p, int sign, Piece.PieceType col, Directions dir) {
        return !isPieceIn(dir.updatePiece(p, -range1, sign), col)
